...
using _4Old_Games.Games.Frogger;
using _4Old_Games.Games.TicTacToe;
using _4Old_Games.Games.Sudoku;
using _4Old_Games.Games.MineSweeper;
...
namespace _4Old_Games {
    public enum Selector { MAIN_SELECTOR, MINE_SWEEPER, SUDOKU,  TICTACTOE, FROGGER, END };
    ...
    public class MainSelector : Microsoft.Xna.Framework.Game {
        ...
        protected override void LoadContent() {
            ...
            mainFont = Content.Load<SpriteFont>("Common\\Font\\MainFont");
            background= Content.Load<Texture2D>("Common\\Image\\background");
            //for mainSelector images(end)
